...
async function signUp(){
  ...
  try{
    const response=await fetch(cleanUrl()+"/auth/v1/signup",{method:"POST",headers:{apikey:SUPABASE_PUBLISHABLE_KEY,"Content-Type":"application/json"},body:JSON.stringify({email:emailInput.value.trim().toLowerCase(),password:passwordInput.value})});
